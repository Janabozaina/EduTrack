...
const notificationLabels: Array<{
  ...
  {
    key: "newStudentAlerts",
    label: "New student notifications",
  },
];
...
export default function SettingsPage() {
  ...
  const [userRole, setUserRole] =
    useState<"ADMIN" | "TEACHER">("TEACHER");
  ...
  return (
    <div className="w-full min-w-0 max-w-full overflow-x-hidden">
      ...
      <div className="grid w-full min-w-0 max-w-full grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <Card>
            <div className="flex flex-col gap-4">
                ...
                {themeOptions.map(
                  (option) => (
                    <button
                      ...
                      className={`rounded-3xl border px-4 py-3 text-center text-sm transition ${
                        theme === option.value
              ...
              <p className="text-sm text-slate-500">
                ...
                locally and will be applied on
                this device.
              </p>
            </div>
          </Card>
          ...
          <Card>
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  These fields are shown for
                  future academy profile support.
                  The current backend does not
                  expose school details.
                </p>
              </div>
          ...
          <Card>
            <div className="flex flex-col gap-4">
                ...
                {notificationLabels.map(
                  (item) => (
                    ...
                    >
                      ...
                      <div
                        className={`h-6 w-14 shrink-0 rounded-full p-1 transition ${
                          notifications[
                            item.key
                          ]
                            ? "bg-indigo-600"
              ...
              <p className="text-sm text-slate-500">
                ...
                locally on this device and do not
                yet sync to the server.
              </p>
            </div>
          </Card>
            ...
            <Card>
              <div className="flex flex-col gap-5">
                ...
                {loadingUsers ? (
                  ...
                  <div className="w-full min-w-0 overflow-x-auto rounded-3xl border border-slate-200">
